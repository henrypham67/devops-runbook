...
| Infrastructure as Code | 3 | Terraform, Ansible, Helm, Kustomize, Atlantis |
...
- [x] M0.1–M0.8 Foundations — prior experience
- [x] M1.1–M1.7 Core DevOps — prior experience
- [x] M2.1–M2.7 Breadth & Production (K8s ops, Helm, IaC at scale, GitOps, observability, DevSecOps) — prior experience
- [x] M2.8 Production delivery — prior experience (confirm: blue-green/canary specifically)

### In progress
- (none — fresh start on the Stage 3 / Senior track)
...
## Notes, blockers & focus
- Strong mid-level / senior-on-tools DevOps engineer; Senior *title* gap is Group C
  + formal SRE + platform-as-product — NOT more tools.
- Decision needed: lean Platform Engineer or SRE? It changes the Stage 3 emphasis.
- Architecture rating (2 vs 3) and M2.8 need confirming in a check-in.
- Don't let a strong toolset mask the Group C gap — that's the real work now
